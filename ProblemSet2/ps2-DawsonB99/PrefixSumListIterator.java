...
public class PrefixSumListIterator implements java.util.Iterator<Integer> {
    ...
    public Integer next() {
        ...
        prefixSum += list.get(current);
        current++;
        return prefixSum;
    }

    /**
    main method to test the PrefixSumListIterator.

    @param args[0] size of list to generate
    ...
    public static void main(String args[]) {
        ...
        // print the array
        System.out.println("Generated list: " + a.toString());

        // print the prefix sums
        System.out.println("Prefix sums:");
        java.util.Iterator<Integer> iter = new PrefixSumListIterator(a);
        while (iter.hasNext()) {
